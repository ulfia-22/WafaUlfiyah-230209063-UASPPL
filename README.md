...
## Daftar Test Case
Beberapa test case yang diimplementasikan dalam project ini antara lain:

- **TC_AUTH_001** – Register akun baru dengan data valid  
- **TC_AUTH_002** – Login dengan kredensial valid  
